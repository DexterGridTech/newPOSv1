...
import type {CateringWelcomeScreenProps} from '../../types'
...
export const WelcomeScreen: React.FC<CateringWelcomeScreenProps> = ({
    terminalId,
}) => {
    ...
    const screenKey = 'ui.integration.catering-shell.welcome'
    ...
    useEffect(() => {
        ...
        const unregisters = [
            automationBridge.registerNode({
                ...
                nodeId: 'ui-integration-catering-shell:welcome',
                testID: 'ui-integration-catering-shell:welcome',
                semanticId: 'ui-integration-catering-shell:welcome',
                role: 'screen',
                text: welcomeTitle,
                visible: true,
                enabled: true,
            ...
            automationBridge.registerNode({
                ...
                nodeId: 'ui-integration-catering-shell:welcome:title',
                testID: 'ui-integration-catering-shell:welcome:title',
                semanticId: 'ui-integration-catering-shell:welcome:title',
                role: 'text',
                text: welcomeTitle,
                visible: true,
                enabled: true,
            ...
            automationBridge.registerNode({
                ...
                nodeId: 'ui-integration-catering-shell:welcome:terminal-id',
                testID: 'ui-integration-catering-shell:welcome:terminal-id',
                semanticId: 'ui-integration-catering-shell:welcome:terminal-id',
                role: 'text',
            ...
            automationBridge.registerNode({
                ...
                nodeId: 'ui-integration-catering-shell:welcome:summary',
                testID: 'ui-integration-catering-shell:welcome:summary',
                semanticId: 'ui-integration-catering-shell:welcome:summary',
                role: 'text',
    ...
    return (
        ...
        >
            ...
            >
                <View style={{gap: 8}}>
                    <Text
                        testID="ui-integration-catering-shell:welcome:eyebrow"
                    ...
                    <Text
                        testID="ui-integration-catering-shell:welcome:subtitle"
