...
export interface CateringShellHarness extends RuntimeReactHarness {}

const createCateringShellMockTransport = (): HttpTransport => ({
...
export const createCateringShellHarness = async (
    input: {
        displayContext?: {
            displayIndex?: number
            displayCount?: number
                    ...
                    createHttpRuntime(context) {
                        return createHttpRuntime({
                            logger: context.platformPorts.logger.scope({
                                moduleName: 'ui.integration.catering-shell.test',
                                subsystem: 'transport.http',
                            }),
                            transport: createCateringShellMockTransport(),
