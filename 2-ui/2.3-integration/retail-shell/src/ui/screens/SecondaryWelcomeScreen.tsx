...
import type {RetailSecondaryWelcomeScreenProps} from '../../types'
...
export const SecondaryWelcomeScreen: React.FC<RetailSecondaryWelcomeScreenProps> = ({
    terminalId,
}) => {
    ...
    useEffect(() => {
        ...
        const unregisters = [
            automationBridge.registerNode({
                ...
                nodeId: 'ui-integration-retail-shell:secondary-welcome',
            ...
            automationBridge.registerNode({
                ...
                nodeId: 'ui-integration-retail-shell:secondary-welcome:title',
            ...
            automationBridge.registerNode({
                ...
                testID: 'ui-integration-retail-shell:secondary-welcome:terminal-id',
                semanticId: 'ui-integration-retail-shell:secondary-welcome:terminal-id',
                role: 'text',
    ...
    return (
        ...
        >
            ...
            >
                <Text
                    testID="ui-integration-retail-shell:secondary-welcome:eyebrow"
                    style={{
                        fontSize: 13,
                        fontWeight: '800',
                ...
                <Text
                    testID="ui-integration-retail-shell:secondary-welcome:brand"
                    style={{
                        fontSize: 16,
                        lineHeight: 24,
            ...
            <Text
                testID="ui-integration-retail-shell:secondary-welcome:footer"
                style={{
                    position: 'absolute',
                    bottom: 28,
                    fontSize: 12,
