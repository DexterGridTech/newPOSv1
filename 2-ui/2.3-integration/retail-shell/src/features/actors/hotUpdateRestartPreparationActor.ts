...
export const RETAIL_SHELL_HOT_UPDATE_RESTART_OVERLAY_ID = 'retail-shell.hot-update.restart-progress'
...
const hasHotUpdateRestartOverlay = (
    ...
    overlay => overlay.id === RETAIL_SHELL_HOT_UPDATE_RESTART_OVERLAY_ID,
)

export const createRetailShellHotUpdateRestartPreparationActorDefinition = (): ActorDefinition =>
    defineActor('RetailShellHotUpdateRestartPreparationActor', [
        onCommand(tdpSyncV2CommandDefinitions.requestHotUpdateRestartPreparation, async context => {
            const logger = context.platformPorts.logger.scope({
                ...
                component: 'RetailShellHotUpdateRestartPreparationActor',
            })

            logger.info({
                category: 'retail-shell.hot-update',
                ...
                data: {
                    ...
                    overlayId: RETAIL_SHELL_HOT_UPDATE_RESTART_OVERLAY_ID,
            ...
            await context.dispatchCommand(createCommand(uiRuntimeV2CommandDefinitions.openOverlay, {
                ...
                id: RETAIL_SHELL_HOT_UPDATE_RESTART_OVERLAY_ID,
                props: {
                    title: '程序更新中',
                    countdownSeconds: HOT_UPDATE_RESTART_COUNTDOWN_SECONDS,
                },
