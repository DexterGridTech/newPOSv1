...
export const SPActivateDeviceScreen: React.FC = () => {
    const [deviceId, setDeviceId] = useState<string>('');

    useLifecycle({
        componentName: 'SPActivateDeviceScreen',
...
export const spActivateDeviceScreenPart: ScreenPartRegistration = {
    name: 'spActivateDeviceScreen',
    title: '设备激活(副屏)',
    description: '设备激活页面（副屏）',
    partKey: 'activate-slave-primary',
    ...
    componentType: SPActivateDeviceScreen,
    indexInContainer: 1,
}
