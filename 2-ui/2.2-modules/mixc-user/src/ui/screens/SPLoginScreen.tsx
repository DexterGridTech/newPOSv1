...
export const SPLoginScreen: React.FC = () => {

    useLifecycle({
        componentName: 'SPLoginScreen',
...
export const spLoginScreenPart: ScreenPartRegistration = {
    name: 'spLoginScreen',
    title: '用户登录(副屏)',
    description: '用户登录页面（副屏）',
    partKey: 'login-slave-primary',
