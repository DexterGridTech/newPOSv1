...
// ==================== 设置操作实体 ====================
router.post('/device/operating-entity', tokenAuth, (req, res) => {
    try {
...
// ==================== 确认指令接收 ====================
router.post('/command/confirm', tokenAuth, (req, res) => {
    try {
...
// ==================== 获取单元数据 ====================
router.post('/unit-data/by-group', tokenAuth, (req, res) => {
    try {
...
// ==================== 发送设备状态 ====================
router.post('/device/state', tokenAuth, async (req, res) => {
    try {
