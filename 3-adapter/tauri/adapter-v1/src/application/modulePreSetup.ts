import {ApplicationConfig, AppModule, InitLogger, registerLogger, registerDevice, registerStateStorage, registerScriptsExecution, registerExternalConnector} from "@impos2/kernel-core-base";
...
export const adapterTauriModulePreSetup = async (config: ApplicationConfig, allModules: AppModule[]) => {
