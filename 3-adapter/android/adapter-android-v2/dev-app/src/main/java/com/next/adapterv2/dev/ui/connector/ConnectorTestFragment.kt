package com.next.adapterv2.dev.ui.connector
...
import com.next.adapterv2.dev.ui.console.statusChip
import com.next.adapterv2.interfaces.ChannelDescriptor
import com.next.adapterv2.interfaces.ChannelType
import com.next.adapterv2.interfaces.ConnectorRequest
import com.next.adapterv2.interfaces.InteractionMode
      ...
      addView(consoleCard("Passive Broadcast") {
        addView(primaryButton("开始监听 passive") {
          if (removePassiveListener != null) {
            ...
            appendEvent("adb shell am broadcast -a com.next.connector.PASSIVE --es source adapter-android-v2 --es message hello")
