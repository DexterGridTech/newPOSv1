...
import com.next.adapterv2.dev.ui.console.moduleTagRow
...
class TestHomeFragment(
  ...
  override fun onCreateView(
    ...
    return consolePage {
      addView(
        consoleTopBar(
          title = "adapter-android-v2 原生能力验证台",
      ...
      addView(consoleCard(tone = ConsoleTone.PRIMARY) {
        addView(MaterialTextView(context).apply {
          text = "用于验证 adapter-android-v2 原生能力，不依赖 RN 运行时。topologyHost 将在独立模块补齐，旧 LocalWebServer 不再作为协议能力保留。"
          textSize = 14f
