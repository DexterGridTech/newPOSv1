package com.impos2.hostruntimern84.restart
...
import com.impos2.hostruntimern84.HotUpdateBundleResolver
import com.impos2.hostruntimern84.MainActivity
import com.impos2.hostruntimern84.HostRuntimeApplication
import com.impos2.hostruntimern84.startup.SecondaryProcessController
import com.impos2.hostruntimern84.startup.StartupAuditLogger
import com.impos2.hostruntimern84.startup.StartupCoordinator
import com.impos2.hostruntimern84.startup.StartupOverlayManager
import com.impos2.hostruntimern84.startup.TopologyLaunchCoordinator
...
class AppRestartManager(activity: MainActivity) {
  ...
  private fun reloadReactHost(activity: MainActivity) {
    val application = activity.application as? HostRuntimeApplication
      ?: error("HostRuntimeApplication unavailable")
    ...
    application.hostRuntimeReactHost.reload("manual-restart")
  }
