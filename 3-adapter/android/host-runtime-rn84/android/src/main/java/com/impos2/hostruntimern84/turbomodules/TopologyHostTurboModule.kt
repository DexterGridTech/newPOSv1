...
import com.impos2.adapterv2.topologyhostv3.TopologyHostV3FaultRule
import com.impos2.adapterv2.topologyhostv3.TopologyHostV3Manager
import com.impos2.adapterv2.topologyhostv3.toJson
    ...
    runCatching {
      ...
      val address = manager.start(
        TopologyHostV3Config(
          port = json.optInt("port", com.impos2.adapterv2.topologyhostv3.TopologyHostV3Defaults.DEFAULT_PORT),
          basePath = json.optString("basePath", com.impos2.adapterv2.topologyhostv3.TopologyHostV3Defaults.DEFAULT_BASE_PATH),
        ),
      )
