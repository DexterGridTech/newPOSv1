...
import com.next.adapterv2.hotupdate.HotUpdatePackageInstaller
import com.next.adapterv2.hotupdate.HotUpdatePackageRequest
...
class HotUpdateTurboModule(reactContext: ReactApplicationContext) :
  ...
  private class HotUpdateTaskThreadFactory : ThreadFactory {
    ...
    override fun newThread(runnable: Runnable): Thread {
      return Thread(runnable, "host-runtime-rn84-hot-update-${sequence.incrementAndGet()}").apply {
        isDaemon = true
      }
    }
  }
