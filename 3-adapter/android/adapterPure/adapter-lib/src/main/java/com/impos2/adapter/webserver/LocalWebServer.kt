...
class LocalWebServer(
    ...
    private fun statsJson(): String {
        ...
        return """{"masterCount":${s.masterCount},"slaveCount":${s.slaveCount},"pendingCount":${s.pendingCount},"uptime":${s.uptime},"requestCount":${requestCount.get()}}"""
    }
