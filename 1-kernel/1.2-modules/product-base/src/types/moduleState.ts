...
export type KernelProductBaseWorkspaceState = CreateModuleWorkspaceStateType<{}>
export type KernelProductBaseInstanceState = CreateModuleInstanceModeStateType<{}>