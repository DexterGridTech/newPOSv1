/** 通道类型 */
export type ChannelType = 'INTENT' | 'AIDL' | 'USB' | 'SERIAL' | 'BLUETOOTH' | 'NETWORK' | 'SDK' | 'HID';
/** 交互模式 */
...
/** 标准错误码 */
export declare const ConnectorCode: {
    /** 未预期的异常 / 兜底错误 */
    readonly UNKNOWN: 9999;
    /** Connector 未注册 */
    readonly NOT_REGISTERED: 9998;
};
