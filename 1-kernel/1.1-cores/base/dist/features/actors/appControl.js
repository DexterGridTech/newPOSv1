...
export class AppControlActor extends Actor {
    clearDataCache = Actor.defineCommandHandler(kernelCoreBaseCommands.clearDataCache, async (command) => {
    ...
    switchServerSpace = Actor.defineCommandHandler(kernelCoreBaseCommands.switchServerSpace, async (command) => {
