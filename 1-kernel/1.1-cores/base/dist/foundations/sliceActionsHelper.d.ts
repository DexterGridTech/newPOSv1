import { PayloadAction, Slice, SliceCaseReducers } from "@reduxjs/toolkit";
/**
 ...
 * ```
 */
export declare function extractSliceActions<State, CR extends SliceCaseReducers<State>, Name extends string = string>(actions: Slice<State, CR, Name>['actions']): {
...
//# sourceMappingURL=sliceActionsHelper.d.ts.map