...
import {DisplayMode, getDisplayMode, getWorkspaceState} from "@impos2/kernel-core-interconnection";
...
const selectUiModels = (state: RootState) => {
    ...
    const uiVariables = getWorkspaceState(kernelCoreNavigationWorkspaceState.uiVariables) as UiVariablesState
