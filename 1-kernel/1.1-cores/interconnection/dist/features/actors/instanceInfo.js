...
export class InstanceInfoActor extends Actor {
    setInstanceToMaster = Actor.defineCommandHandler(kernelCoreInterconnectionCommands.setInstanceToMaster, async (command) => {
        storeEntry.dispatchAction(instanceInfoActions.setInstanceMode(InstanceMode.MASTER));
        return {};
    });
    setInstanceToSlave = Actor.defineCommandHandler(kernelCoreInterconnectionCommands.setInstanceToSlave, async (command) => {
    ...
    setDisplayToPrimary = Actor.defineCommandHandler(kernelCoreInterconnectionCommands.setDisplayToPrimary, async (command) => {
    ...
    setDisplayToSecondary = Actor.defineCommandHandler(kernelCoreInterconnectionCommands.setDisplayToSecondary, async (command) => {
    ...
    setEnableSlave = Actor.defineCommandHandler(kernelCoreInterconnectionCommands.setEnableSlave, async (command) => {
        storeEntry.dispatchAction(instanceInfoActions.enableSlave(true));
        return {};
    });
    setDisableSlave = Actor.defineCommandHandler(kernelCoreInterconnectionCommands.setDisableSlave, async (command) => {
        storeEntry.dispatchAction(instanceInfoActions.enableSlave(false));
        return {};
    });
    setMasterInfo = Actor.defineCommandHandler(kernelCoreInterconnectionCommands.setMasterInfo, async (command) => {
        storeEntry.dispatchAction(instanceInfoActions.setMasterInfo(command.payload));
        return {};
    });
    clearMasterInfo = Actor.defineCommandHandler(kernelCoreInterconnectionCommands.clearMasterInfo, async (command) => {
