...
import { getDisplayMode, getInstanceMode, getStandalone } from "../../foundations/accessory";
export class InitializeActor extends Actor {
    initialize = Actor.defineCommandHandler(kernelCoreBaseCommands.initialize, async (command) => {
...
export const powerStatusChangeListener = (event) => {
