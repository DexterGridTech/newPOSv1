...
import { createInstanceModeSlice } from "../../foundations";
...
export const slice = createInstanceModeSlice(kernelCoreInterconnectionInstanceState.requestStatus, initialState, {
    commandStart: (state, action) => {
