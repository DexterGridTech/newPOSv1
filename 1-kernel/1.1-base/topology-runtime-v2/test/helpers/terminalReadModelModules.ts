...
export const TERMINAL_TOPOLOGY_BRIDGE_SLICE_NAME = 'kernel.base.topology-runtime-v2.test.terminal-bridge'
...
export const TERMINAL_TOPOLOGY_BRIDGE_COMMAND = defineCommand<{
    ...
    moduleName: 'kernel.base.topology-runtime-v2.test.terminal-bridge',
    commandName: 'consume-projection',
})

export const TERMINAL_TASK_PANEL_SLICE_NAME = 'kernel.base.topology-runtime-v2.test.task-panel'
...
export const TERMINAL_REMOTE_COMMAND_PANEL_SLICE_NAME = 'kernel.base.topology-runtime-v2.test.remote-command-panel'
...
export const createTerminalBridgeModuleV2 = (): KernelRuntimeModuleV2 => {
    ...
    const actorDefinitions: ActorDefinition[] = [
        {
            moduleName: 'kernel.base.topology-runtime-v2.test.terminal-bridge-module',
...
export const createTerminalTaskPanelModuleV2 = (): KernelRuntimeModuleV2 => {
    const slice = createSlice({
    ...
    return {
        moduleName: 'kernel.base.topology-runtime-v2.test.task-panel-module',
        packageVersion: '0.0.1',
        stateSlices: [
...
export const createTerminalRemoteCommandPanelModuleV2 = (): KernelRuntimeModuleV2 => {
    const slice = createSlice({
    ...
    return {
        moduleName: 'kernel.base.topology-runtime-v2.test.remote-command-panel-module',
        packageVersion: '0.0.1',
        stateSlices: [
