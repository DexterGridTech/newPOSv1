...
export type TdpProjectionBucketKey = string

export interface TdpProjectionIndexEntry {
    projectionId: TdpProjectionId
    bucketKey: TdpProjectionBucketKey
    envelope: TdpProjectionEnvelope
}
