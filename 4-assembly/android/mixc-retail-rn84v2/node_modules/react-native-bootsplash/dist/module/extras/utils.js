...
export const setLoggerMode = value => {
  loggerMode = value;
};
...
export const log = {
  ...
  write: (filePath, dimensions) => {
    if (loggerMode.type === "cli") {
      console.log(`    ${path.relative(loggerMode.cwd, filePath)}` + (dimensions != null ? ` (${dimensions.width}x${dimensions.height})` : ""));
    }
  }
};
...
export const transformProps = async (rootPath, {
  ...
  const darkLogoPath = withDefaults.darkLogo != null ? path.resolve(rootPath, withDefaults.darkLogo) : undefined;
  const brandPath = withDefaults.brand != null ? path.resolve(rootPath, withDefaults.brand) : undefined;
  const darkBrandPath = withDefaults.darkBrand != null ? path.resolve(rootPath, withDefaults.darkBrand) : undefined;
  ...
  const darkBackground = withDefaults.darkBackground != null ? parseColor(withDefaults.darkBackground) : undefined;
