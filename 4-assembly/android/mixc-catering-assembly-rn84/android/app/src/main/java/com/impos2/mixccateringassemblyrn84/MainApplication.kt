 ...
 */
class MainApplication : Application(), ReactApplication, com.impos2.hostruntimern84.HostRuntimeApplication {
    ...
    object : DefaultReactNativeHost(this) {
      ...
      override fun getJSBundleFile(): String? {
        if (BuildConfig.ENABLE_HOT_UPDATE_BUNDLE_RESOLVER) {
          ...
          val resolvedBundle = com.impos2.hostruntimern84.HotUpdateBundleResolver(this@MainApplication).resolveBundleFile(
  ...
  override fun onCreate() {
    super.onCreate()
    com.impos2.hostruntimern84.HostRuntimeConfig.mainComponentName = "MixcCateringAssemblyRN84"
    com.impos2.hostruntimern84.HostRuntimeConfig.secondaryActivityClass = SecondaryActivity::class.java
