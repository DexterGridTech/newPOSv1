package com.next.mixccateringassemblyrn84
 ...
 */
class MainApplication : Application(), ReactApplication, com.next.hostruntimern84.HostRuntimeApplication {
    ...
    object : DefaultReactNativeHost(this) {
      ...
      override fun getJSBundleFile(): String? {
        if (BuildConfig.ENABLE_HOT_UPDATE_BUNDLE_RESOLVER) {
          ...
          val resolvedBundle = com.next.hostruntimern84.HotUpdateBundleResolver(this@MainApplication).resolveBundleFile(
  ...
  override val hostRuntimeReactHost: ReactHost
    get() = reactHost
  ...
  override fun onCreate() {
    super.onCreate()
    com.next.hostruntimern84.HostRuntimeConfig.mainComponentName = "MixcCateringAssemblyRN84"
    com.next.hostruntimern84.HostRuntimeConfig.secondaryActivityClass = SecondaryActivity::class.java
