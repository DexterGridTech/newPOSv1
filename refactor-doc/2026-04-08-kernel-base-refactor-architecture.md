...
1. 这 7 个包不是为了机械替代旧 `base / interconnection / communication` 三个包，而是为了把旧架构正确的思想按职责重新收口。
2. 新包划分必须同时体现“统一 runtime”与“显式边界”两种要求。
3. 任何一个新包如果只能通过重新引入全局单例或隐藏耦合才能工作，都说明划分仍有问题。
